...
public class MovieCrudService {
	...
	public List<Movie> listMovies() {
		Movie movie1 = new Movie("111", "Pupl Fiction");
		Movie movie2 = new Movie("222", "Love Actually");
		Movie movie3 = new Movie("333", "As Good As It Gets");
		inventory.put(movie1.getImdbId(), movie1);
		inventory.put(movie2.getImdbId(), movie2);
		inventory.put(movie3.getImdbId(), movie3);
